"use strict";
class Videoplayer {
    constructor(createVideo, src, colorbar, colorarea, colorprogress) {
        this.isntance = document.querySelector(createVideo);
...
<div class="playPause">
  ...
  <a href="#"class="forward" ><i class="fa-solid fa-forward-step forward"></i> </a>
   ...
   <i class="fa-solid fa-expand fullScreen"></i>`;
    ...
    addeventlitener() {
        const playVideo = this.controls.querySelector(".play");
        const pause = this.controls.querySelector(".pause");
        const sound = this.controls.querySelector(".sound");
        const notmute = this.controls.querySelector(".notmute");
        const mute = this.controls.querySelector(".mute");
        const soundRange = this.controls.querySelector(".soundRange"); //input
        const fullScreen = this.controls.querySelector(".fullScreen");
        const videoPlayer = this.controls.querySelector(".mainVideo");
        const duration = this.controls.querySelector(".duration");
        const current = this.controls.querySelector(".current");
        const progressBar = this.controls.querySelector(".progressBar"); //HTML element if i want to style
        const progressArea = this.controls.querySelector(".progressArea");
        const backward = this.controls.querySelector(".backward");
        const forward = this.controls.querySelector(".forward");
        const playPause = this.controls.querySelector(".playPause");
        ...
        soundRange.addEventListener("input", (event) => {
            const realRange = Number(event.target.value);
        ...
        this.video.addEventListener("loadeddata", (event) => {
            let totalDuration = event.target.duration; //defult value
        ...
        this.video.addEventListener("timeupdate", (event) => {
            let currentTime = event.target.currentTime; //defult value
            let totalDuration = event.target.duration; //defult value
        ...
        progressArea.addEventListener("click", (event) => {
            let totalDuration = this.video.duration; //event.target=> progressArea/ this=>video because of arrow fn refers to the parent not the actual element
